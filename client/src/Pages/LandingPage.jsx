              ...
              <div className="relative sm:overflow-hidden">
                <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                  ...
                  <p className="mx-auto mt-6 max-w-lg text-center text-xl text-gray-500 sm:max-w-3xl">
                    Split bills with your friends easily and efficiently.
                    Register today with your friends
                  </p>
                  ...
                  <div>
                    ...
                    <div className="mt-6">
                      ...
                      <p className="mt-4 text-lg text-gray-500">
                        ...
                        <span className="font-bold">Divvy UP</span> You can
                        create a friend list of you choice and add expense
                        individually.
                      </p>
                      <div className="mt-6">
                        <Link
                ...
                <div className="mx-auto max-w-xl px-4 sm:px-6 lg:col-start-2 lg:mx-0 lg:max-w-none lg:py-32 lg:px-0">
                  <div>
                    ...
                    <div className="mt-6">
                      ...
                      <p className="mt-4 text-lg text-gray-500">
                        We have got it covered you add expenses. Take Expense
          ...
          <div className="bg-gradient-to-r from-blue-800 to-indigo-700">
            <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:pt-20 sm:pb-24 lg:max-w-7xl lg:px-8 lg:pt-24">
              ...
              <p className="mt-4 max-w-3xl text-lg text-gray-200">
                SplitBill has lots of features. Explore the features below to
